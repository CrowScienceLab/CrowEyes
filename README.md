...
CrowEyes 1.6은 가볍고 빠른 Windows 이미지 뷰어에 파일 탐색·관리·출력을 연결한 Windows 10/11 x64용 데스크톱 프로그램입니다. 제작자는 Crow Science Lab입니다.

## 다운로드

GitHub Releases에서 용도에 맞는 파일을 받습니다.

- 설치형: `CrowEyes_Setup_1.6_Windows_x64.exe`
- 무설치형: `CrowEyes_Portable_1.6_Windows_x64.zip`
...
python CrowEyes_Image_Viewer_1.6.py
```
